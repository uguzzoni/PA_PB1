"""
optimize_sequences_multimer.py

Same 2-stage optimization protocol as optimize_sequences.py, but uses
...
Usage:
    python optimize_sequences_multimer.py ACDEFGHIKLMNPQRST
    python optimize_sequences_multimer.py ACDEFGHIKLMNPQRST -n 4 --ew_2 0.05 --ew_3 0.2
    python optimize_sequences_multimer.py ACDEFGHIKLMNPQRST --iters_2 0 --ew_3 0.5
    python optimize_sequences_multimer.py --seq_file input_sequences.txt -n 4 --ew_2 0.02 --ew_3 0.2
    python optimize_sequences_multimer.py --seq_file input_sequences.txt --iters_2 0 --ew_3 0 -n 1
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Optimize binder sequence(s) with AF2-Multimer and per-stage energy weights."
    )
    ...
    out_file = args.output or os.path.join(
        OUT_DIR,
        f"optimized_multimer_{stage2_tag}_ew{EW_2:.2f}_{EW_3:.2f}.json"
    )
