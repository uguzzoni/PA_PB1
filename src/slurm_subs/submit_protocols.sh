...
# 12 design protocols:
#
#  Group A – generate from scratch  (20 seqs each, generate_sequences.py)
#    0  gen_colabonly        : 4-stage colab, no energy
#    1  gen_energy_A         : energy weights low   (1a=0.02 1b=0.05 2=0.02 3=0.05)
#    2  gen_energy_B         : energy weights medium (1a=0.02 1b=0.10 2=0.02 3=0.20)
#    3  gen_energy_C         : energy weights high  (1a=0.05 1b=0.20 2=0.05 3=0.50)
#
...
case "$PROTO" in
    ...
    gen_colabonly)
        python3 $GEN_SCRIPT -n 20 \
            --ew_1a 0.00 --ew_1b 0.00 --ew_2 0.00 --ew_3 0.00 \
            -o $OUTPUT
        ;;
    ...
    gen_energy_B)
        python3 $GEN_SCRIPT -n 20 \
            --ew_1a 0.02 --ew_1b 0.10 --ew_2 0.02 --ew_3 0.20 \
            -o $OUTPUT
        ;;
    ...
    # ── Group B: optimize from input sequences ──────────────────────────────
